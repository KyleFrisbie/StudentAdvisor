...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { department: @professor.department, first_name: @professor.first_name, last_name: @professor.last_name, record_number: @professor.record_number }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { department: @professor.department, first_name: @professor.first_name, last_name: @professor.last_name, record_number: @professor.record_number }
    assert_redirected_to professor_path(assigns(:professor))
  end
